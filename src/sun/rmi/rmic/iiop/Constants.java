...
public interface Constants extends sun.rmi.rmic.Constants {
    ...
    public static final int TYPE_VOID                   = 0x00000001;   
    public static final int TYPE_BOOLEAN                = 0x00000002;   
    public static final int TYPE_BYTE                   = 0x00000004;   
    public static final int TYPE_CHAR                   = 0x00000008;   
    public static final int TYPE_SHORT                  = 0x00000010;   
    public static final int TYPE_INT                    = 0x00000020;   
    public static final int TYPE_LONG                   = 0x00000040;   
    public static final int TYPE_FLOAT                  = 0x00000080;   
    public static final int TYPE_DOUBLE                 = 0x00000100;   

    public static final int TYPE_STRING                 = 0x00000200;   
    public static final int TYPE_ANY                    = 0x00000400;   
    public static final int TYPE_CORBA_OBJECT   = 0x00000800;   

    public static final int TYPE_REMOTE                 = 0x00001000;   
    public static final int TYPE_ABSTRACT               = 0x00002000;   
    public static final int TYPE_NC_INTERFACE   = 0x00004000;   

    public static final int TYPE_VALUE                  = 0x00008000;   
    public static final int TYPE_IMPLEMENTATION = 0x00010000;   
    public static final int TYPE_NC_CLASS               = 0x00020000;   

    public static final int TYPE_ARRAY                  = 0x00040000;   
    public static final int TYPE_JAVA_RMI_REMOTE = 0x00080000;  
