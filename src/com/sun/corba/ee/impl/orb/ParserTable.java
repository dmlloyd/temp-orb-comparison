    ...
    private ParserTable( UnaryFunction<String,Class<?>> cnr ) {
        ...
        ParserData[] pd = {
            ...
            ParserDataFactory.make( ORBConstants.DISABLE_DIRECT_BYTE_BUFFER_USE_PROPERTY,
                OperationFactory.booleanAction(),
                "disableDirectByteBufferUse", Boolean.TRUE, 
                Boolean.TRUE, "true" ), 
        ...
        Operation sfop = new Operation() {
            public Object operate( Object value ) 
            {
                ...
                try {
                    ...
                    if (com.sun.corba.ee.spi.legacy.connection.ORBSocketFactory.class
        ...
        Operation sfop = new Operation() {
            public Object operate( Object value ) 
            {
                ...
                try {
                    ...
                    if (com.sun.corba.ee.spi.transport.ORBSocketFactory.class
        ...
        Operation op = new Operation() {
            public Object operate( Object value ) 
            {
                ...
                try {
                    ...
                    if (ContactInfoListFactory.class.isAssignableFrom(
